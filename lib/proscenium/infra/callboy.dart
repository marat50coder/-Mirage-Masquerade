...
class Callboy {
  ...
  Future<void> _boot() async {
    ...
    FirebaseMessaging.onBackgroundMessage(houseBackgroundMessage);
  ...
  Future<bool> canOfferPermission() async {
    ...
    // suppressed the CallSlip re-show even after the snooze window
    // (HouseBrief.pushSnoozeSeconds) had elapsed.
    try {
      await boot();
    } catch (_) {}
    final messaging = _messaging;
