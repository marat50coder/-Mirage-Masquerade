...
class CallSlip extends StatefulWidget {
  const CallSlip({
    super.key,
    required this.vault,
  ...
  @override
  State<CallSlip> createState() => _CallSlipState();
}

class _CallSlipState extends State<CallSlip> {
  bool _working = false;
  ...
  Widget build(BuildContext context) {
    ...
    final background =
        landscape ? 'assets/house/permit_h.webp' : 'assets/house/permit_v.webp';
